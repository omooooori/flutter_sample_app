...
abstract class $SearchResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String masterName, String masterTypeId, int score});
}
    ...
    return _then(_value.copyWith(
      ...
      masterName: null == masterName
          ...
          : masterName // ignore: cast_nullable_to_non_nullable
              as String,
      masterTypeId: null == masterTypeId
          ? _value.masterTypeId
...
class _$SearchResultImpl implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, masterName: $masterName, masterTypeId: $masterTypeId, score: $score)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, masterName, masterTypeId, score);
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      required final String masterTypeId,
      required final int score}) = _$SearchResultImpl;
...
mixin _$SearchResponse {
  List<SearchResult> get search => throw _privateConstructorUsedError;
...
abstract class $SearchResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<SearchResult> search});
}
...
class _$SearchResponseImpl implements _SearchResponse {
  const _$SearchResponseImpl({required final List<SearchResult> search})
      : _search = search;

  factory _$SearchResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$SearchResponseImplFromJson(json);

  final List<SearchResult> _search;
  @override
  List<SearchResult> get search {
...
abstract class _SearchResponse implements SearchResponse {
  const factory _SearchResponse({required final List<SearchResult> search}) =
